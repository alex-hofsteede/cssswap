...
def editpage(request,page_id):
    ...
    return render_to_response('edit.html', {'page':page,'stylesheets':stylesheets,'styleattributes':styleattributes,'delimiter':util.delimiter}, context_instance=RequestContext(request))
